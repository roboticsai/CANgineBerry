...
$TOOL_PATH/coia -p $1 --node-write 3,0x6200,1,1,0x55 --delay 50 --node-write 3,0x6200,2,1,0x66 --delay 50 --node-write 3,0x6200,3,1,0x77 --delay 50 --node-write 3,0x6200,4,1,0x88
